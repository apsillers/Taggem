module.exports = function(utilities, changeListener, entities, activeEntities, entitiesByLocation, mapData) {
    ...
    objects.Pit = function(options) {
        ...
        this.place(this.z, this.x, this.y);
    }
    ...
    objects.FreezeShot = function(options) {
        ...
        this.place(this.z, this.x, this.y, true);
    }
    objects.FreezeShot.prototype = entityProto;
    ...
    objects.FireballShot.prototype = entityProto;
    ...
    objects.FreezeWand.prototype = entityProto;
    ...
    objects.FireballWand.prototype = entityProto;
